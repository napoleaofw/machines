    ...
    public function run()
    {
        ...
        if(Auth::check()) {
            ...
            foreach($recordsUser as $recordUser) {
                ...
                $recordsEstablishment = $recordUser->establishments()->saveMany(factory(Establishment::class, rand(5, 15))->make());
                ...
                foreach($recordsEstablishment as $recordEstablishment) {
                    ...
                    $recordsMachine = $recordEstablishment->machines()->saveMany(factory(Machine::class, rand(2, 8))->make());
                    ...
                    foreach($recordsMachine as $recordMachine) {
                        ...
                        $recordsTransaction = $recordMachine->transactions()->saveMany(factory(Transaction::class, rand(2, 12))->make([
